...
<html lang="en" class="no-ie">
   ...
   <body>
      ...
      <div id="questionModal" tabindex="-1" role="dialog"
                        ...
                        <div class="panel widget">
                           ...
                           <div class="panel-body">
                              ...
                              <div class="form-group form-inline">
                                 ...
                                 <select name="modal_questionType" class="modal_questionType form-control m-b">
         ...
         <input type="submit" class="btn btn-primary" id="modal_saveQuestionBtn" value="Save changes" name="modal_saveQuestionBtn"></input>
         </div>
         </div>
         </div>
         </form>
      ...
      <div id="segmentModal" tabindex="-1" role="dialog"
         aria-labelledby="myModalLabel" aria-hidden="true" class="modal fade">
         <form action="UpdateSegmentController" method="post">
            <div class="modal-dialog">
               <div class="modal-content panel-primary">
                  <div class="modal-header panel-heading">
                  ...
                  <div class="modal-footer">
                     <button type="button" data-dismiss="modal" class="btn btn-default">Close</button>
                     <input type="submit" class="btn btn-primary" value="Save changes" id="modal_saveSegmentBtn" name="modal_saveSegmentBtn"/>
                  </div>
               </div>
            </div>
         </form>
      ...
      <div id="addQuestionModal" tabindex="-1" role="dialog"
         ...
         <div class="modal-footer">
         <button type="button" data-dismiss="modal" class="btn btn-default">Close</button>
         <input type="submit" class="btn btn-primary" id="modal_save_addQuestionBtn" value="Save changes" name="modal_save_addQuestionBtn"></input>
         </div>
         </div>
         </div>
         </form>
      ...
      <div id="addSegmentModal" tabindex="-1" role="dialog"
         ...
         <div class="modal-footer">
         <button type="button" data-dismiss="modal" class="btn btn-default">Close</button>
         <input type="submit" class="btn btn-primary" id="modal_save_addSegmentBtn" value="Save changes" name="modal_save_addSegmentBtn"></input>
         </div>
         </div>
         </div>
         </form>
      ...
      <script type="text/javascript">
          ...
          $(document).on('click', 'button.addQuestion', function() {
             ...
             $('#addQuestionModal_sid').val(sid);	   
           	...
           	$(document).on('click', '#deleteSegmentBtn', function() {
           		...
           		/*   var segJson = { "segmentid": sid,"formName": formName}; */
           		  
           		 
           		/* alert("sid: "+sid);
           		alert("sname: "+formName);	    */ 		
           		 ...
           		 $.ajax({
                   	...
                   	data: {segmentid : segid},            	
                      	...
                      	success: function(data){ 		
                      	  	...
                      	  	alert("deleted...");
                      	 	location.href =  "viewForm.jsp?selected_formName="+formName;
         ...
         $(document).on('click', '.deleteQuestionBtn', function() {
           		...
           		//var sid = $(this).closest('div .segmentRow').attr('id');	
           		var qid = $(this).closest('fieldset').attr('id');
           		var formName=$('#formName').text();
           		//var segmentDescription='';
           	/* 	alert("qid:"+qid); */
