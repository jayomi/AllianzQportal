                              ...
                              <tbody>
                                 ...
                                 <tr class="gradeC">
                                    ...
                                    <%-- <td><%=start %></td>
                                       <td><%=end %></td> --%>
                                    <th>
                                       <a href="summary.jsp?formId=<%=formId%>&turn=<%=turnList.get(j)%>&department=<%=department %>" class="btn btn-info btn-sm">
                                 ...
                                 <tr class="gradeC">
                                    ...
                                    <td><%=formType.getFormType()%></td>
                                    <td><%=formType.getFormAccessType()%></td>
                                    <!--   <td><span class="label label-primary pull-right">Go</span></td> -->
                                    <%--   <td><%=start %></td>
                                       <td><%=end %></td> --%>
                                    <th>
                                       <a href="summary.jsp?formId=<%=formId%>&department=<%=department %>" class="btn btn-info btn-sm">
                                       <em class="fa fa-hand-o-right"></em>
                                       <span>View</span>
                                       </a>
                                    </th>
