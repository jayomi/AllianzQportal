    ...
    pageEncoding="UTF-8"%>
            ...
            <nav class="sidebar">
                <ul class="nav">
                    ...
                    <li class="active">
                        <a href="modaratorDashboard.jsp" title="Dashboard" data-toggle="" class="no-submenu">
	                ...
	                <li>
                      ...
                      <li>
	                     <a href="modarator_selectForm.jsp" data-toggle="" class="no-submenu" title="Manage Forms">
                 ...
                 <!--     <li>
                          <a href="FormAssignToUser.jsp" data-toggle="" class="no-submenu" title="Form Assign To User">
                            <em class="fa fa-file-text"></em>
                              <span class="item-text">Form Assign To User</span>
                          </a>
                    </li>  --> 
                    <!--  <li>
                          <a href="FormAssignToDepartment.jsp" data-toggle="" class="no-submenu" title="Form Assign To User">
                            <em class="fa fa-file-text"></em>
                              <span class="item-text">Form Assign To Department</span>
                          </a>
                    </li>  -->
                     <li>
                          <a href="department.jsp" data-toggle="" class="no-submenu" title="Form Assign To User">
                            <em class="fa fa-file-text"></em>
                              <span class="item-text">View Forms</span>
                          </a>
                    </li>
                    ...
                    <li class="nav-heading">Manage Users</li>
	                   ...
	                   <li>
		                     <a href="modarator_selectUser.jsp" data-toggle="" class="no-submenu" title="Manage Forms">
		                           <em class="fa fa-folder"></em>
		                           <!--  <span class="item-text">Manage Questionnaires</span> -->
