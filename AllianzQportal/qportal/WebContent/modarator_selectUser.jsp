            ...
            <html lang="en" class="no-ie">
               ...
               <body>
                                       ...
                                       <table id="datatable1" class="table table-striped table-hover">
                                          ...
                                          <tbody>
                                             <%								
                                                ...
                                                List <User> userList = userImpl.getUserListByDepartment(loggedUserDepartment);
                              ...
                              <div class="modal-body">
                                 ...
                                 <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-8">
                                          <input id="modal_role" name="modal_role" type="text" placeholder="role"
                                             class="form-control">
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-8">
                                          <select id="modal_department" name="modal_department" class="form-control">
                                             <option value="">Select</option><!-- if there are sub branches -->                                            
                  ...
                  <script type="text/javascript">
                     ...
                     alert("delete_userId"+delete_userId);
