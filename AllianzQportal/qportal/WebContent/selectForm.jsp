...
<body>
                     ...
                     <div class="panel-body">
                        <table id="datatable1" class="table table-striped table-hover">
                           <thead class="tableHead">
                              <tr><b>
                                 <th style="width: 350px;">Form Name</th>
                                 <th>Description</th>
                                 <!-- <th>Created Date</th>
                                 <th>End Date</th> -->
                                 <th>Type</th>
                           ...
                           <tbody >
								<%								
									...
									List<FormType> formList = departmentImpl.getAllFormList();
									...
									for(FormType formType:formList){%>						
										...
										<tr >
											...
											<th>
											<button id="deleteForm" type="button" formid="<%=formType.getFormId()%>" departmentRowIndex="<%= formType.getDepRowIndex()%>" class="deleteForm pull-right btn-danger btn-xs" title="Delete Form">
 ...
 <!--  start form modal   -->  
	...
	<div id="formModal" tabindex="-1" role="dialog"
		...
		<form class="form-horizontal" action="UpdateFormController" method="post">
		<div class="modal-dialog">
			<div class="modal-content panel-primary">
				...
				<div class="modal-body">
					...
					<div class="col-lg-12">
                           ...
                           <div class="form-group">
                            ...
                            <%
								DepartmentImpl departmentImple = new DepartmentImpl();
								List<Department> departmentList =	departmentImple.getAllDepartments();									 
							%>
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-primary" value="Save changes" id="modal_saveFormBtn" name="modal_saveFormBtn">Save changes</button>
				</div>
			</div>
		</div>
		</form>
	    	...
	    	//alert(formid);
	    		...
	    		$.ajax({
	               	...
	               	success: function(data){           		
	               		...
	               		formAccessType = data.formAcessType;
	                    ...
	                    $('#modal_formAccessType').val(formAccessType);	                    
