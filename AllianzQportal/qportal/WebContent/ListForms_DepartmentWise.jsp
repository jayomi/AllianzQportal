                                    ...
                                    <div class="panel-body">
                                       <table id="datatable1" class="table table-striped table-hover">
                                          ...
                                          <tbody>
                                             ...
                                             <tr class="gradeC">
                                                <td>
                                                   <div id="tableRowId" hidden="hidden"><%=form.getId()%></div>
                                                </td>
                                                ...
                                                <th>
                                                   <button type="button" rowIndex="<%=form.getId()%>" data-toggle="modal" data-target="#departmentModal" class="editDepartmentBtn btn btn-info btn-sm">
                                                   <em class="fa fa-hand-o-right"></em>
                                                   <span>Edit</span>
                                                   </button>												
                                                </th>
                                                <th>
                                                   <button id="deleteFormAssignedToDept" type="button" rowIndex="<%=form.getId()%>" class="pull-right btn-danger btn-sm" title="Delete Row">
                        ...
                        <div class="modal-dialog">
                           <div class="modal-content panel-primary">
                              ...
                              <div class="modal-footer">
                                 ...
                                 <button type="submit" class="btn btn-primary" id="modal_saveUpdateDeptBtn" name="modal_saveUpdateDeptBtn">Save changes</button>
                              </div>
                           </div>
                        </div>
                     </form>
