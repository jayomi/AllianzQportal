                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <ol class="breadcrumb">
                                            <li><a href="#">Home</a></li>
                                            <li class="active"><span>Master Report</span></li>
                                        </ol>                                       
                                    </div>
                                </div>
                                <div class="row">
                                                    ...
                                                    <div class="form-group form-group-sm">
                                                        ...
                                                        <select style="width:200px" id="sel2Multi" name="ext" multiple>
                                                            ...
                                                            <%
                                                                ...
                                                                for (Object ext : bc.getMList()) {
                                                            %>

                                                            <option value="<%=ext.toString().substring(1, ext.toString().length() - 1)%>"><%=ext.toString().substring(1, ext.toString().length() - 1)%></option>
                                                            <% }
                                    ...
                                    <div class="col-lg-12">
                                        <div class="main-box clearfix">
                                            <header class="main-box-header clearfix">
                                                <div class="pull-left"> <i class="fa fa-circle green"></i> Incoming &nbsp; <i class="fa fa-circle purple"></i> Outgoing &nbsp; <i class="fa fa-circle red"></i> Missed </div>
