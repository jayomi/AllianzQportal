    ...
    <body>
                                        ...
                                        <div class="main-box no-header clearfix">
                                            <div class="main-box-body clearfix">
                                                <div class="table-responsive">
                                                    <table class="table table-striped user-list user-list table-hover">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            <%BaseController pc = new BaseController();
                                                                for (map.Register ac : pc.getPList()) {
                                                                    if (!ac.getStatus().equals("Approved")) {
                                                            %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <span class="label label-warning"> <%=ac.getStatus()%></span>
                                                                </td>

                                                                <td style="width: 20%;">
                                                                    <a data-toggle="modal" href="#myModal" class="table-link" onclick="getExt('<%=ac.getIdregister()%>')">
                                                                        <span class="fa-stack">
                                                                            <i class="fa fa-square fa-stack-2x"></i>
                                                                            <i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
                                                                        </span>
                                                                    </a>
                                                                     <a href="#" class="table-link danger" onclick="deleteUser('<%= ac.getIdregister() %>')">
                                                                        <span class="fa-stack">
                                                                            <i class="fa fa-square fa-stack-2x"></i>
        ...
        <script>
            ...
            function getExt(id) {
                $('#userid').val(id);
                $('#sel2Multi').empty();
                var query = "getExtension?action=getex&id=" + id;
             ...
             function deleteUser(id){
               if (confirm('Are you sure you want to delete user?')) {
                   ...
                   var query = "reg?action=deleteUser&id="+ id;
                   $.get(query,function(data,status){
