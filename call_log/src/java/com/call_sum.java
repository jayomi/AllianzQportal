 ...
 * @author AKILAK
 */
@WebServlet(name = "call_sum", urlPatterns = {"/call_sum"})
public class call_sum extends HttpServlet {
...
//            System.out.println(sum);
            ...
            for (map.UserHasExt uext : u.getUserHasExts()) {
                ...
                extar.add(uext.getExtension().getVirtualExt());//added at 2016-03-14
            }
...
//
                ...
                for (DateTime l1 : l) {
                    ...
                    for (String ext1 : extar) {
                        ...
                        out.write("<td style=\"text-align:center\">" + getInCount(sum, l1.toDate(), ext1) + "</td>");
                        out.write("<td style=\"text-align:center\">" + getInDuration(sum, l1.toDate(), ext1) + "</td>");
...
//
                ...
                for (DateTime l1 : l) {
                    ...
                    out.write("<td style=\"text-align:center\">" + sdf.format(l1.toDate()) + "</td>");
                    for (String ext1 : ext) {
//                        System.out.println(sdf.format(l1.toDate()) + " " +ext1 + " in " + getInCount(sum, l1.toDate(), ext1));
//                        System.out.println(sdf.format(l1.toDate()) + " " +ext1 + " out " + getOutCount(sum, l1.toDate(), ext1));
