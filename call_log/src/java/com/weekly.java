 ...
 * @author AKILAK
 */
@WebServlet(name = "weekly", urlPatterns = {"/week"})
...
//
                ...
                for (int i = 0; i < 7; i++) {
                    ...
                    out.write("<td style=\"text-align:center\">" + days[i] + "</td>");
                    for (String ext1 : extar) {
...
//
    ...
    public static JSONArray getSum(String[] ext, Date start, Date end) {
        ...
        String sql = "SELECT\n"
                ...
                + ")GROUP BY DAY(call_log.date),information_element\n"
...
//                System.out.println((set1 == val) + " " + val + " " + set1);
    ...
    public static int getInCount(JSONArray sum, int day, String ext) throws JSONException, ParseException {
        ...
        for (int j = 0; j < sum.length(); j++) {
            ...
            int wday = jsonobject.getInt("wday");
            if (ext.equals(jsonobject.getString("ext")) && wday == day) {
...
//                                            System.out.println("incoming Header " + ext + " DB " + jsonobject.getString("ext") + " Info " + jsonobject.get("info") + " " + db);
    ...
    public static int getOutCount(JSONArray sum, int day, String ext) throws JSONException, ParseException {
        int outcount = 0;
...
//                          System.out.println("outgoing Header " + exten + " DB " + jsonobject.getString("ext") + " Info " + jsonobject.get("info") + " " + db);
    ...
    public static String getInDuration(JSONArray sum, int day, String ext) throws JSONException, ParseException {
...
//                          System.out.println("outgoing Header " + exten + " DB " + jsonobject.getString("ext") + " Info " + jsonobject.get("info") + " " + db);
    ...
    public static String getOutDuration(JSONArray sum, int day, String ext) throws JSONException, ParseException {
        ArrayList<String> timestampsList = new ArrayList<>();
