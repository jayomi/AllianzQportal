...
public class search extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            LiveController sc = new LiveController();

            for (map.CallLog cl : sc.getList(ext, info, ctype, call, rtype, ring, user)) {
                ...
                if (SearchController.getOutgoing().contains(cl.getInformationElement().toString()) || cl.getInformationElement() > 40) {
                ...
                map.Branch br = (map.Branch) s.createQuery("from Branch where tel='" + cs.convert(cl.getStationNo()) + "'").uniqueResult();
                if (br != null) {
                ...
                out.write("<td><span data-pk=\"" + cl.getIdcallLog() + "\"  data-url=\"comment\" data-type=\"textarea\" data-placeholder=\"Your comments here...\" data-title=\"Enter comments\" class=\"editable editable-pre-wrapped editable-click\">" + cmt + "</span></td>");
