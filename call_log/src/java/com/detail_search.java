 ...
 * @author AKILAK
 */
@WebServlet(name = "live_search", urlPatterns = {"/detail_search"})
public class detail_search extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (map.CallLog cl : sc.getListD(new Date(dr[0].trim()), new Date(dr[1].trim()), ext, info, null, null, ctype, call, rtype, ring, station, keyword, user)) {
